...
namespace Collections.Infrastructure.Migrations
{
    ...
    [Migration("20230211161133_Initial")]
            ...
            modelBuilder.Entity("Collections.Infrastructure.Identity.Models.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "096883d7-4cb0-49f3-ba34-a52932d9abda",
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            Id = "081065ba-cd04-40a4-9bb7-4b82d1651454",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "85e743aa-34a5-430d-96fb-ac92e6058d06",
                            Name = "Author",
            ...
            modelBuilder.Entity("Collections.ApplicationCore.Models.UserProfile", b =>
                {
                    b.HasOne("Collections.Infrastructure.Identity.Models.ApplicationUser", null)
                        .WithOne()
                        .HasForeignKey("Collections.ApplicationCore.Models.UserProfile", "ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
