    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExtraFieldValueTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserCollectionThemes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserProfileId = table.Column<int>(type: "integer", nullable: false),
                    UserCollectionThemeId = table.Column<int>(type: "integer", nullable: false),
                    ApplicationUserId = table.Column<string>(type: "text", nullable: false),
                    ImageSource = table.Column<string>(type: "text", nullable: true),
                    AddedOn = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserCollections_UserCollectionThemes_UserCollectionThemeId",
                        column: x => x.UserCollectionThemeId,
                        principalTable: "UserCollectionThemes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Items_UserCollections_UserCollectionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExtraFieldValueTypeId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExtraFields_ExtraFieldValueTypes_ExtraFieldValueTypeId",
                        column: x => x.ExtraFieldValueTypeId,
                        principalTable: "ExtraFieldValueTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExtraFields_Items_ItemId",
                        column: x => x.ItemId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExtraFields_ExtraFieldValueTypeId",
                table: "ExtraFields",
                column: "ExtraFieldValueTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_ExtraFields_ItemId",
                table: "ExtraFields",
                column: "ItemId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Items_UserCollectionId",
                table: "Items",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserCollections_UserCollectionThemeId",
                table: "UserCollections",
                column: "UserCollectionThemeId");
