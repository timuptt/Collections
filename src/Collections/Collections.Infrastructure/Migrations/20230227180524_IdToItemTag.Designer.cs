...
namespace Collections.Infrastructure.Migrations
{
    ...
    [Migration("20230227180524_IdToItemTag")]
    partial class IdToItemTag
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Collections.ApplicationCore.Models.UserCollection", b =>
                {
                    ...
                    b.HasIndex("Description", "Title")
                        .HasAnnotation("Npgsql:TsVectorConfig", "english");

                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("Description", "Title"), "GIN");
            ...
            modelBuilder.Entity("Collections.Infrastructure.Identity.Models.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "2fadd0b3-7b47-4198-a2f0-a09e91747804",
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            Id = "6b79976a-6c4a-4601-9d10-93f97cccb24a",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "38408f2a-ca1f-48c4-abca-c65039d0d6c3",
                            Name = "Author",
            ...
            modelBuilder.Entity("Collections.Infrastructure.Identity.Models.ApplicationUserRole", b =>
                {
            ...
            modelBuilder.Entity("Collections.Infrastructure.Identity.Models.ApplicationUserRole", b =>
                {
                    b.HasOne("Collections.Infrastructure.Identity.Models.ApplicationRole", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Collections.Infrastructure.Identity.Models.ApplicationUser", "User")
                        .WithMany("UserRoles")
